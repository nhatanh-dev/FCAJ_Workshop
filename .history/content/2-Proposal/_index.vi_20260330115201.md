...
- Amazon RDS PostgreSQL (APS1-InstanceUsage:db.t3.micro): ~20,44 USD
- Amazon CloudFront (Data Transfer Out): ~1,20 USD
- AWS Elastic Beanstalk (EC2 & Application Load Balancer): ~50,00 USD
- Amazon S3, SQS & Các dịch vụ mạng khác: ~4,91 USD

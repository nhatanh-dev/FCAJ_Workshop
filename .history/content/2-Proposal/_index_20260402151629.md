...
- **Amazon VPC (2x NAT Gateways for 2 AZs):** ~$86.00 USD *(Fixed cost to ensure EC2 and ECS can securely connect to the Internet)*
- **ECS Fargate Spot (AI OCR):** Flexible millisecond billing based on invoice processing (Pay-As-You-Go) (~$7.00 USD).
- **Amazon CloudFront, S3, SQS & Cloud Map:** ~$5.00 USD *(Optimized via Service Discovery and low-cost storage)*

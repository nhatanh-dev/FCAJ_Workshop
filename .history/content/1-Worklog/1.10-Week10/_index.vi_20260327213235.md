...
| 5 | - Tập trung gỡ lỗi và resolve các conflict lớn giữa các branch hệ thống.<br>- Hoàn thiện các tính năng quản lý khách hàng (Tenant Management) và Quản lý nhóm (Team Management).<br>- Sửa các lỗi tồn đọng cho chức năng Thùng rác (Trash Invoice) và Xuất dữ liệu Excel. | 19/03/2026 | 20/03/2026 | |
